...
class RollingUpdate(messages.Message):
  ...
  kind = messages.StringField(9, default=u'replicapoolupdater#rollingUpdate')
  policy = messages.MessageField('PolicyValue', 10)
  progress = messages.IntegerField(11, variant=messages.Variant.INT32)
