...
class AttachedDisk(messages.Message):
  ...
  index = messages.IntegerField(6, variant=messages.Variant.INT32)
  initializeParams = messages.MessageField('AttachedDiskInitializeParams', 7)
  interface = messages.EnumField('InterfaceValueValuesEnum', 8)
  kind = messages.StringField(9, default=u'compute#attachedDisk')
  licenses = messages.StringField(10, repeated=True)
  mode = messages.EnumField('ModeValueValuesEnum', 11)
  source = messages.StringField(12)
  type = messages.EnumField('TypeValueValuesEnum', 13)
...
class Disk(messages.Message):
  ...
  kind = messages.StringField(6, default=u'compute#disk')
  licenses = messages.StringField(7, repeated=True)
  name = messages.StringField(8)
  options = messages.StringField(9)
  selfLink = messages.StringField(10)
  sizeGb = messages.IntegerField(11)
  sourceImage = messages.StringField(12)
  sourceImageEncryptionKey = messages.StringField(13)
  sourceImageId = messages.StringField(14)
  sourceSnapshot = messages.StringField(15)
  sourceSnapshotEncryptionKey = messages.StringField(16)
  sourceSnapshotId = messages.StringField(17)
  status = messages.EnumField('StatusValueValuesEnum', 18)
  storageType = messages.EnumField('StorageTypeValueValuesEnum', 19)
  type = messages.StringField(20)
  zone = messages.StringField(21)
...
class Image(messages.Message):
  ...
  kind = messages.StringField(9, default=u'compute#image')
  licenses = messages.StringField(10, repeated=True)
  name = messages.StringField(11)
  rawDisk = messages.MessageField('RawDiskValue', 12)
  selfLink = messages.StringField(13)
  sourceDisk = messages.StringField(14)
  sourceDiskEncryptionKey = messages.StringField(15)
  sourceDiskId = messages.StringField(16)
  sourceType = messages.EnumField('SourceTypeValueValuesEnum', 17, default=u'RAW')
  status = messages.EnumField('StatusValueValuesEnum', 18)
...
class Snapshot(messages.Message):
  ...
  sourceDisk = messages.StringField(11)
  sourceDiskEncryptionKey = messages.StringField(12)
  sourceDiskId = messages.StringField(13)
  status = messages.EnumField('StatusValueValuesEnum', 14)
  storageBytes = messages.IntegerField(15)
  storageBytesStatus = messages.EnumField('StorageBytesStatusValueValuesEnum', 16)
